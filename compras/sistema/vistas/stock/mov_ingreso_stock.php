...
if (isset($_POST['ingreso'])) {
    ...
    $_SESSION['tablaMov'][] = [$id, $cantidad, $fila[0], $umedida, $observaciones];
}
...
if (isset($_POST['registrar'])) {
    ...
    echo "<script>
        alert('Registro de Entrada registrado correctamente');
        </script>";
...
<head>
    ...
    <title>Movimiento Ingreso</title>
    <style>
        .hidden {
            display: none;
        }
...
<body>
    ...
    <div class=" m-3">
        ...
        <h3 class="bg-success text-center text-light">Movimiento de Ingreso</h3>

        <div class="row ">
            <div class="col-sm-9 offset-sm-1 py-3 bg-secondary text-light">
    ...
    <div class="container mt-3 mb-5">
        <h4 class="text-center bg-success text-light">Detalle del movimiento</h4>
        <table class="table">
            <thead>
                <th>ID</th>
                <th>Cant.</th>
